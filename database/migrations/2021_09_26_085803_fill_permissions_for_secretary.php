...
class FillPermissionsForSecretary extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSecretary constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.secretary',
            'admin.secretary.index',
            'admin.secretary.create',
            'admin.secretary.show',
            'admin.secretary.edit',
            'admin.secretary.delete',
        ]);
