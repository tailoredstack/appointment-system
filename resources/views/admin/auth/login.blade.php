                    ...
                    <auth-form :action="'{{ url('/admin/login') }}'" :data="{}" inline-template>
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/login') }}"
                            ...
                            <div class="auth-header">
                                ...
                                <p class="auth-subtitle">{{ trans('brackets/admin-auth::admin.login.sign_in_text') }}
                                </p>
                            </div>
                            <div class="auth-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block btn-spinner"><i
                                            class="fa"></i> {{ trans('brackets/admin-auth::admin.login.button')
                                        }}</button>
                                </div>
                                <div class="form-group text-center">
                                    <a href="{{ url('/admin/register') }}" class="auth-ghost-link">Don't have an account
                                        yet? Register</a>
                                </div>
                            </div>
                        </form>
